...
const offersHeader: OfferHeaderCard[] = [
  { label: 'total offers', task: 10 },
  { label: 'open offers', task: 4 },
  { label: 'completed offers', task: 2 },
  { label: 'cancelled offers', task: 2 },
]
...
export default function Offer() {
  return (
    <div className="flex flex-col gap-2 px-4">
      <Heading className="my-2">Offers</Heading>
      <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-4">
        {offersHeader.map((item, index) => {
